...
public class TwitchStreamNotFoundExceptionTests extends AbstractTest {

    @Test
    @DisplayName("The twitch stream not found exception stores message properly")
    public void captures_message() {
        String testMessage = "apples";
        assertEquals(new TwitchStreamNotFoundException(testMessage).getMessage(), testMessage);
    }
}
