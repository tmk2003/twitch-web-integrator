...
public class TwitchTotalFollowersNotFoundExceptionTests extends AbstractTest {

    @Test
    @DisplayName("The twitch total follower not found exception stores message properly")
    public void captures_message() {
        String testMessage = "apples";
        assertEquals(new TwitchTotalFollowersNotFoundException(testMessage).getMessage(), testMessage);
    }
}
