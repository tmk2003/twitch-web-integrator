...
public class TwitchFollowerNotFoundExceptionTests extends AbstractTest {
    ...
    public void captures_message() {
        ...
        assertEquals(new TwitchFollowerNotFoundException(testMessage).getMessage(), testMessage);
    }
}
