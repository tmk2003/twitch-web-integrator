...
public class TwitchUserNotFoundExceptionTests extends AbstractTest {

    @Test
    @DisplayName("The twitch user not found exception stores message properly")
    public void captures_message() {
        String testMessage = "apples";
        assertEquals(new TwitchUserNotFoundException(testMessage).getMessage(), testMessage);
    }
}
